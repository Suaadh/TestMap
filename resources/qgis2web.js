...
map.getView().fit([8829238.222031, 716152.018905, 9183101.422174, 947019.504272], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">SL Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (49 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map has the roads and waterways of Sri Lanka';
            }
